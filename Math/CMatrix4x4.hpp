#ifndef _CMATRIX4X4_H_
#define _CMATRIX4X4_H_
//======================================================================================
...
// The following functions create a matrix holding a particular transformation
...
const float EPSILON2 = 0.5e-6f; // For 32-bit floats, requires zero to 6 decimal places
inline bool IsZero2(const float x)
{
